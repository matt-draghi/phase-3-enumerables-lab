...
def print_spicy_foods(spicy_foods)
  ...
  spicy_foods.each do |food|
    pepper_count = "🌶" * food[:heat_level]
    puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{pepper_count}"
  end
end
...
def sort_by_heat(spicy_foods)
  # your code here
  spicy_foods.sort {|foodA, foodB| foodA[:heat_level] <=> foodB[:heat_level]}
end
...
def average_heat_level(spicy_foods)
  ...
  average = heat_levels.sum / heat_levels.length 
  average
end
